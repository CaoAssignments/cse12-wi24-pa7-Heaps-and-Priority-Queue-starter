...
# CSE 12 Winter 2024 PA7 - Heaps and Priority Queue


## Due date: Thursday, February 29th @ 11:59 PM PST
...
In this part of the assignment, you will implement a MinHeap and then use that MinHeap to implement a Priority Queue.
...
In this assignment, we provide a `PublicTester.java` file that contains all the public test cases (visible on Gradescope) that we will use to test your `MinMyHeap`, `MyPriorityQueue` and `lastAtom()` function (see Part 1c). **This assignment does not require the implementation of a custom tester file.** We still encourage you to write your own tests to verify that your implementation follows the write-up specifications.
...
<li>The <code>deleteIndex</code> explanation can be found in the <a href="https://github.com/CaoAssignments/cse12-wi24-pa7-Heaps-and-Priority-Queue-starter#diagram-for-deleteindex">Appendix</a>
...
<p>
The insertion explanation can be found in the <a href="https://github.com/CaoAssignments/cse12-wi24-pa7-Heaps-and-Priority-Queue-starter#diagram-for-insert">Appendix</a>
  </tr>
  <tr>
